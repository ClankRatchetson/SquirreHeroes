...
export interface RunStoreState {
  ...
  /** `bonuses` : agrégat de l'arbre de Glands d'Or (Phase 5), calculé par l'écran de sélection de héros. */
  readonly startNewRun: (seed: number, bonuses?: AggregatedTreeBonuses) => void;
